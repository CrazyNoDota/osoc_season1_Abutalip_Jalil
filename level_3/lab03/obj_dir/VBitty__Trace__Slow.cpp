...
void VBitty::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        {int i; for (i=0; i<11; i++) {
                tracep->declBus(c+102+i*1,"regs", true,(i+0), 15,0);}}
        tracep->declBit(c+113,"done", false,-1);
        {int i; for (i=0; i<11; i++) {
                tracep->declBus(c+114+i*1,"dout", true,(i+0), 15,0);}}
        tracep->declBit(c+125,"write", false,-1);
        tracep->declBit(c+126,"run", false,-1);
        {int i; for (i=0; i<11; i++) {
                tracep->declBit(c+127+i*1,"regen", true,(i+0));}}
        tracep->declBit(c+99,"Bitty clk", false,-1);
        tracep->declBit(c+100,"Bitty reset", false,-1);
        tracep->declBus(c+101,"Bitty din", false,-1, 15,0);
        {int i; for (i=0; i<11; i++) {
                tracep->declBus(c+102+i*1,"Bitty regs", true,(i+0), 15,0);}}
        tracep->declBit(c+113,"Bitty done", false,-1);
        {int i; for (i=0; i<11; i++) {
                tracep->declBus(c+114+i*1,"Bitty dout", true,(i+0), 15,0);}}
        tracep->declBit(c+125,"Bitty write", false,-1);
        tracep->declBit(c+126,"Bitty run", false,-1);
        {int i; for (i=0; i<11; i++) {
                tracep->declBit(c+127+i*1,"Bitty regen", true,(i+0));}}
        {int i; for (i=0; i<11; i++) {
        ...
        tracep->declBit(c+126,"Bitty ControlUnit1 run", false,-1);
        ...
        tracep->declBit(c+113,"Bitty ControlUnit1 done", false,-1);
...
void VBitty::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullSData(oldp+102,(vlTOPp->regs[0]),16);
        tracep->fullSData(oldp+103,(vlTOPp->regs[1]),16);
        tracep->fullSData(oldp+104,(vlTOPp->regs[2]),16);
        tracep->fullSData(oldp+105,(vlTOPp->regs[3]),16);
        tracep->fullSData(oldp+106,(vlTOPp->regs[4]),16);
        tracep->fullSData(oldp+107,(vlTOPp->regs[5]),16);
        tracep->fullSData(oldp+108,(vlTOPp->regs[6]),16);
        tracep->fullSData(oldp+109,(vlTOPp->regs[7]),16);
        tracep->fullSData(oldp+110,(vlTOPp->regs[8]),16);
        tracep->fullSData(oldp+111,(vlTOPp->regs[9]),16);
        tracep->fullSData(oldp+112,(vlTOPp->regs[10]),16);
        tracep->fullBit(oldp+113,(vlTOPp->done));
        tracep->fullSData(oldp+114,(vlTOPp->dout[0]),16);
        tracep->fullSData(oldp+115,(vlTOPp->dout[1]),16);
        tracep->fullSData(oldp+116,(vlTOPp->dout[2]),16);
        tracep->fullSData(oldp+117,(vlTOPp->dout[3]),16);
        tracep->fullSData(oldp+118,(vlTOPp->dout[4]),16);
        tracep->fullSData(oldp+119,(vlTOPp->dout[5]),16);
        tracep->fullSData(oldp+120,(vlTOPp->dout[6]),16);
        tracep->fullSData(oldp+121,(vlTOPp->dout[7]),16);
        tracep->fullSData(oldp+122,(vlTOPp->dout[8]),16);
        tracep->fullSData(oldp+123,(vlTOPp->dout[9]),16);
        tracep->fullSData(oldp+124,(vlTOPp->dout[10]),16);
        tracep->fullBit(oldp+125,(vlTOPp->write));
        tracep->fullBit(oldp+126,(vlTOPp->run));
        tracep->fullBit(oldp+127,(vlTOPp->regen[0]));
        tracep->fullBit(oldp+128,(vlTOPp->regen[1]));
        tracep->fullBit(oldp+129,(vlTOPp->regen[2]));
        tracep->fullBit(oldp+130,(vlTOPp->regen[3]));
        tracep->fullBit(oldp+131,(vlTOPp->regen[4]));
        tracep->fullBit(oldp+132,(vlTOPp->regen[5]));
        tracep->fullBit(oldp+133,(vlTOPp->regen[6]));
        tracep->fullBit(oldp+134,(vlTOPp->regen[7]));
        tracep->fullBit(oldp+135,(vlTOPp->regen[8]));
        tracep->fullBit(oldp+136,(vlTOPp->regen[9]));
        tracep->fullBit(oldp+137,(vlTOPp->regen[10]));
